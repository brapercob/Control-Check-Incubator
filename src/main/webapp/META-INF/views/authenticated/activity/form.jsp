...
<acme:form readonly="true">
	...
	<acme:form-moment code="authenticated.activity.form.label.start-date-time" path="startDateTime"/>
	<acme:form-moment code="authenticated.activity.form.label.end-date-time" path="endDateTime"/>
